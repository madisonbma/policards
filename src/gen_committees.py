...
def gen_house():
    """
    Pulls committee assignments for House members
    """
...
def gen_senate():
    """
    Pulls committee assignments for Senate members
    """
...
def gen_committees():
    """
    Generates the committee assignments for all members of Congress
    Returns:
        A dictionary where the key is the bioguideID and the value is a
        list of all committee and subcommittee assignments.
    """
